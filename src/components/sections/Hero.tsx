  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `
            linear-gradient(rgba(0,191,165,0.018) 1px, transparent 1px),
            linear-gradient(90deg, rgba(0,191,165,0.018) 1px, transparent 1px)`,
      ...
      <div
        className="absolute top-[5%] left-[5%] w-[700px] h-[500px] rounded-full pointer-events-none aurora-orb-1"
        style={{
          background: "radial-gradient(ellipse, rgba(0,191,165,0.09) 0%, transparent 70%)",
          filter: "blur(80px)",
        }}
      />
      <div
        className="absolute bottom-[10%] right-[5%] w-[600px] h-[600px] rounded-full pointer-events-none aurora-orb-2"
        style={{
      ...
      />
      <div
        className="absolute top-[calc(50%-200px)] left-[calc(50%-200px)] w-[400px] h-[400px] rounded-full pointer-events-none aurora-orb-3"
        style={{
          background: "radial-gradient(ellipse, rgba(168,85,247,0.045) 0%, transparent 70%)",
          filter: "blur(100px)",
        }}
      />
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full">
        <div className="grid lg:grid-cols-[1fr_460px] gap-8 lg:gap-14 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Slot-machine role rotator */}
            <div className="h-10 sm:h-12 flex items-center justify-center lg:justify-start mb-7 overflow-hidden">
            ...
            <div className="max-w-xl mx-auto lg:mx-0 text-[#8892A4] text-base sm:text-lg leading-relaxed mb-10">
        ...
        >
          <button
            ...
            className="flex flex-col items-center gap-1.5 text-[#3D4F65] hover:text-[#00BFA5] transition-colors duration-300 cursor-pointer group"
          >
